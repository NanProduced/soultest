...
export const RELATIONSHIP_PREFERENCE_PAIR_NARRATIVES = {
    "words_of_affirmation|quality_time": "你既需要被认真说出来，也需要被认真放在当下。只有表达、没有投入不够；只有陪伴、没有回应也不够。",
    "words_of_affirmation|receiving_gifts": "你在意的是“被记住”与“被清楚表达”。一句有分量的话，加上一份带记忆点的小心意，会非常打动你。",
    "words_of_affirmation|acts_of_service": "你很难被空话打动，但也不喜欢沉默式付出。对你最有效的是：说到，也做到。",
    "words_of_affirmation|physical_touch": "你需要的是语言上的确认，加上身体上的靠近。被温柔说出口、再被靠近，最容易让你放下防备。",
    "quality_time|receiving_gifts": "你既在意“陪你的人是不是真的在场”，也在意“这段关系有没有被具体记住”。时间和心意都要落地。",
    "quality_time|acts_of_service": "你重视高质量相处，也重视实际照顾。你要的不是形式浪漫，而是有人认真陪你，也认真帮你。",
    "quality_time|physical_touch": "你需要的是有存在感的陪伴。一起待着、认真聊天、自然靠近，这些都会让你迅速感到安心。",
    "receiving_gifts|acts_of_service": "你最容易被“心意”与“落实”一起打动。光有惊喜不够，真正照顾到你会更有分量。",
    "receiving_gifts|physical_touch": "你既会被有纪念感的小心意打动，也会被真实靠近安抚到。你在意关系里有没有“可感知的温度”。",
    "acts_of_service|physical_touch": "你偏爱的爱不是高调表达，而是可靠地出现、照顾、靠近。有人把你接住，这件事本身就很浪漫。",
};
...
export const relationshipPreferenceResultContent = {
    words_of_affirmation: {
        ...
        overview: "你很看重“爱有没有被说出来”。对你来说，真正打动人的，往往不是一句泛泛的“爱你”，而是那些具体、认真、带着观察的表达。你会记得别人是怎么称赞你、理解你、回应你的，也会对敷衍、沉默、理所当然特别敏感。当关系里长期缺少明确表达，你不一定会立刻发作，但心里会慢慢出现“我到底有没有被珍惜”的空缺感。",
        strengthSummary: "你最容易被认真看见、被具体肯定、被清楚地说出来。",
        blindSpotSummary: "长期没有回应、只有模糊表达，会让你慢慢失去被珍惜的确认感。",
        relationshipStyle: "你并不是只听甜言蜜语的人，但一段关系若完全没有语言上的回应，你会明显感觉少了点什么。当对方愿意把欣赏、感谢、偏爱说出口，你会更容易确认这段关系的温度。",
        stressMode: "你并非不喜欢被夸，而是相比“说得好听”，你更在意别的爱的证据。如果只有漂亮话，却没有陪伴、行动或其他你真正在意的表达，你不太会因此被真正打动。",
    ...
    quality_time: {
        ...
        overview: "你最需要的，不是形式上的陪伴，而是“这个时刻里你真的在我这里”。对你来说，两个人是否同处一个空间并不够，关键在于对方有没有把注意力、耐心和真实参与感给到你。被打断、被边聊边看手机、被随口敷衍，都会比别人更容易让你觉得失落。你真正会记住的，往往是那些被认真倾听、被完整陪伴、被优先安排进日程的时刻。",
        strengthSummary: "被认真倾听、被完整陪伴、被优先安排进日程，是你最有感觉的被爱方式。",
        blindSpotSummary: "人在你面前，注意力却不在你这里，会比“没见面”更让你失落。",
        relationshipStyle: "你对时间投入很敏感，哪怕主语言不是它，你依然会因为“对方有没有认真在场”来判断关系温度。当陪伴质量很高时，你对这段关系的安全感会明显上升。",
        stressMode: "你不排斥陪伴，只是相比“花多久在一起”，你更看重别的表达方式。如果相处时间普通，但其他你更在意的通道被满足，你依然可能感觉关系是稳定的。",
    ...
    receiving_gifts: {
        ...
        overview: "你在意的不是价格，而是那种“对方有把我记在心里”的具体证据。对你来说，一份礼物的价值常常不在贵，而在准：它是否真的贴近你的喜好、回忆、需要与被惦记感。你容易被那些带着观察、纪念和心思的小东西打动，因为它们会把爱从抽象情绪变成能被看见、留住、反复回想的证据。",
        strengthSummary: "那些被认真准备、很“像你”的小心意，会让你感觉自己真的被记住了。",
        blindSpotSummary: "重要时刻总被忘记，或者心意总停留在嘴上不落地，会让你觉得少了一层被认真对待。",
        relationshipStyle: "你会被礼物打动，尤其当它不是完成任务式送出，而是真的和你有关。它像是你关系里的“加深记忆点”，会让你更容易记住被爱的瞬间。",
        stressMode: "你不是不喜欢收礼物，而是礼物本身通常不是你判断爱的主要通道。如果只有礼物、没有其他更核心的表达，你未必会因此感到足够满足。",
    ...
    acts_of_service: {
        ...
        overview: "你对“爱有没有落到行动上”非常敏感。对你来说，真正让人安心的，往往不是说得多漂亮，而是对方有没有愿意动手、分担、照顾、落实。当你累、乱、忙的时候，有人替你把事情接过去、把细节处理好、把负担分掉，你会比收到很多漂亮话更有被爱的感觉。如果一个人总是“嘴上有你，行动里没你”，你会很快失去耐心。",
        strengthSummary: "记得、做到、提前安排、主动帮忙、减少你的负担，都是你最容易接收到的爱。",
        blindSpotSummary: "关键时刻接不住、只会安慰不愿意上手，会让你很快觉得关系不够可靠。",
        relationshipStyle: "你对行动兑现度很看重，虽然不一定排第一，但它会直接影响你对关系可靠性的判断。对你来说，照顾不是浪漫的对立面，反而是很真实的浪漫。",
        stressMode: "你当然会感谢别人帮忙，但相比“做了什么”，你可能更先被别的通道打动。单纯的照顾与安排，不一定足以让你感觉情感被真正触达。",
    ...
    physical_touch: {
        ...
        overview: "你对身体距离很敏感，亲密感常常是通过“靠近”被真正确认的。一个拥抱、一只牵住的手、靠在一起的安静时刻、情绪不好时被抱住安抚，这些都会直接影响你对关系温度的感受。对你来说，身体接触不是可有可无的小动作，而是一种非常直接的“我在你身边”的信号。当关系里长期缺少自然靠近、亲密触碰或身体上的回应，你会很容易感觉疏离。",
        strengthSummary: "自然的靠近、牵手、拥抱与温柔回应，会让你快速感到安心和被在乎。",
        blindSpotSummary: "日常里越来越少自然靠近，或者在你需要安抚时没有身体回应，会让你很快感到被推远。",
        relationshipStyle: "你对身体靠近有明显好感，它会增强你被在乎、被接住的感受。当接触和你的主语言一起出现时，你会更快进入关系里的安心状态。",
        stressMode: "你并不排斥亲密接触，只是它通常不是你判断关系好坏的第一信号。如果别的核心通道没有被满足，再多拥抱也未必能真正解决你的失落感。",
