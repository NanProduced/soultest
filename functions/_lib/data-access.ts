...
export async function getAdminQuizVerificationSummary(quizId: string, env: CloudflareEnv): Promise<AdminQuizVerificationSummary> {
  ...
  if (!bindingRow) {
    return {
      ...
      activeCodeCount: 0,
      sampleCodes: [],
    } satisfies AdminQuizVerificationSummary
  }
